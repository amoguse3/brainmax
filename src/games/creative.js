...
import { openGame, finish } from './engine.js?v=18';
...
export function startCreative(){
  ...
  function add(){
    ...
    if(cats[c]>=3) coach.textContent='Stuck in '+c+'. Jump to another domain.'; else coach.textContent='Good. Now try something that sounds impossible.';
  }
